...
function AddExpenseToGroupForm() {
  const { addGroupExpense, error, setError } = useGlobalContext();
    ...
    <form className="flex flex-col gap-8" onSubmit={handleSubmit}>
      ...
      <div className="input-control">
        <input
          ...
          value={title}
          name={"title"}
          placeholder="Group Expense Title"
      ...
      <div className="input-control">
        <input
          ...
          type="text"
          name={"amount"}
          placeholder={"Group Expense Amount"}
